...
export function MetaStatus() {
  return (
    <section className="mt-6 grid gap-3 md:grid-cols-3">
      ...
      <StatusCard icon={<Save className="h-5 w-5" />} label="Loadouts" value="Organização rápida" note="Monte combinações de Warframe, armas e notas para Steel Path, Farm, Bosses e missões rápidas." />
    </section>
  );
}
