...
export default async function HomePage() {
  ...
  return (
    <>
      <header className="hero-bg relative overflow-hidden border-b border-border/70">
        ...
        <div className="relative mx-auto grid min-h-[440px] w-[min(1180px,calc(100%-32px))] content-between py-7 sm:min-h-[480px]">
          <nav className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="leading-tight">
                <strong className="block text-sm text-foreground">Warframe Meta</strong>
                <span className="text-xs font-semibold uppercase text-cyan-200/80">Tier List</span>
              </div>
            </div>
            <div className="hidden items-center gap-2 text-xs font-bold uppercase text-cyan-100 sm:flex">
              <span className="border border-cyan-300/25 bg-cyan-300/10 px-3 py-2">Primes</span>
              <span className="border border-yellow-300/25 bg-yellow-300/10 px-3 py-2 text-yellow-100">Incarnon</span>
            </div>
          </nav>
          ...
          <div className="pb-10 pt-12 sm:pt-16">
            <span className="inline-flex border border-cyan-300/40 bg-background/75 px-3 py-2 text-xs font-bold uppercase tracking-normal text-cyan-100 shadow-[0_10px_40px_rgba(0,0,0,.28)] backdrop-blur">
              Base 42.0.10 - revisado em 14 maio 2026
            </span>
